...
// Official/known YouTube videos. The section is presented as "عروض وإعلانات" rather than "فيديوهات ومشاهد تجريبية".
const videos=[
 ['My Hero Academia — العرض الرسمي للموسم 7','إعلان رسمي من Crunchyroll','T5HMoxJRhRY'],
 ['Naruto — العرض الرسمي','إعلان رسمي من VIZ','BLDCotASQnQ'],
 ['Demon Slayer — العرض السينمائي','عرض أنمي','VQGCKyvzIM4'],
 ['Jujutsu Kaisen — العرض الرسمي','عرض أنمي','pkKu9hLT-t8'],
 ['Attack on Titan — العرض الرسمي','عرض أنمي','MGRm4IzK1SQ'],
 ['Bleach — Thousand-Year Blood War','عرض أنمي','78WIYzX_m98']
];

const imgCache=new Map();
const coverOverrides={
 'anime21':'https://cdn.myanimelist.net/images/anime/1244/138851l.jpg',
 'anime20':'https://cdn.myanimelist.net/images/anime/13/17405l.jpg',
 ...
 'anime859':'https://cdn.myanimelist.net/images/anime/2/12785l.jpg',
 'anime1535':'https://cdn.myanimelist.net/images/anime/1079/138100l.jpg',
 'manga2':'https://cdn.myanimelist.net/images/manga/1/157897l.jpg',
 'manga13':'https://cdn.myanimelist.net/images/manga/2/253146l.jpg',
 'manga42':'https://cdn.myanimelist.net/images/manga/1/267145l.jpg',
 'manga44347':'https://cdn.myanimelist.net/images/manga/2/216846l.jpg',
 'manga118846':'https://cdn.myanimelist.net/images/manga/3/248344l.jpg',
 'manga23390':'https://cdn.myanimelist.net/images/manga/1/153899l.jpg',
 'manga3':'https://cdn.myanimelist.net/images/manga/2/259030l.jpg',
 'manga15':'https://cdn.myanimelist.net/images/manga/3/179098l.jpg'
};
...
function openVideoPlayer(videoId,title){videoPlayerTitle.textContent=title;youtubePlayer.src=`https://www.youtube.com/embed/${encodeURIComponent(videoId)}?playsinline=1&rel=0&modestbranding=1&origin=${encodeURIComponent(location.origin)}`;playerModal.classList.add('open');playerModal.setAttribute('aria-hidden','false');document.body.classList.add('modal-lock')}
...
const menu=document.querySelector('#mainNav'),menuBtn=document.querySelector('#menuBtn');menuBtn.onclick=()=>{const open=menu.classList.toggle('open');menuBtn.setAttribute('aria-expanded',open)};document.querySelectorAll('.nav a').forEach(a=>a.onclick=()=>{menu.classList.remove('open');menuBtn.setAttribute('aria-expanded','false')});document.querySelectorAll('[data-filter]').forEach(btn=>btn.onclick=()=>document.getElementById(btn.dataset.filter).scrollIntoView({behavior:'smooth'}));getCover(21,'anime').then(u=>{if(u)document.querySelector('#heroBackdrop').style.backgroundImage=`url('${u}')`});
